...
URL = 'https://www.dropbox.com/scl/fi/tm7le6u06y2q1d5vfcxjo/List-of-Succesful-Students-Loan-Scheme-Beneficiaries-AY2021-22-Lot-1-Diploma-Degree-Jan-10th-2022.pdf?rlkey=c1eeh0jergnxnlo4nogj8vlnw&dl=0'
PDF_PATH = ''
SAVE_FILE_PATH = ''

# Set up logging
log_file_path = os.path.join(SAVE_FILE_PATH, 'UG_HESFB_2021_undergraduate_beneficiaries_1.log')
            ...
            if j == 0:
                for i, text in enumerate(page_text):
                    ...
                    if i == 2:
                        ...
                        write_row_to_csv(row, SAVE_FILE_PATH, 'data_undergraduate_beneficiaries_1')
                    else:
