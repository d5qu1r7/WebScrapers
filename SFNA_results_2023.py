...
baselink = 'https://onlinesys.necta.go.tz/results/2023/sfna/sfna.htm'
...
#----------------------------------------------------------- Loop Through School -----------------------------------------------------------#
                    ...
                    for row_school in all_rows_school:
                        ...
                        for column_school in full_row_school:
                            ...
                            #FIXME This is just for testing, and only clicks on the first link
                            if i == 4 and j == 2 and l < 110: 
                                l += 1
                                continue
